...
Bench-verified 2026-06-09 on pgsd-bare-metal: all four checks passed
(sentinel 0 on a fresh daemon; keyboard, pointer, and touch each
advance the value independently; a non-root caller receives fresh
advancing values). See `semadraw/docs/D11_VERIFICATION.md`.
